...
@MapperScan(basePackages = "com.simba.goodfitmanager.dao", sqlSessionFactoryRef = "goodFitManagerSqlSessionFactory")
public class MyBatisConfig {
    ...
    @Bean(name = "goodFitManagerSqlSessionFactory")
    @Primary
    public SqlSessionFactory goodFitManagerSqlSessionFactory() throws Exception {
...
//        sessionFactory.setTypeAliasesPackage("com.zdran.springboot.dao");
    ...
    @Bean(name = "goodFitManagerDataSource")
